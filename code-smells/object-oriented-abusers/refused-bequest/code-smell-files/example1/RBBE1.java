...
class Bicycle implements Vehicle {
    ...
    @Override
    public void refuel() {
        throw new UnsupportedOperationException("Bicycle does not support refueling");
    }

    @Override
    public void replaceEngine(String newEngine) {
        throw new UnsupportedOperationException("Bicycle does not support an engine");
    }
}
